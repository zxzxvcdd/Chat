		 ...
		 setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
	      ...
	      btnNewButton.addMouseListener(new MouseAdapter() {
	         public void mouseClicked(MouseEvent e) {
	            ...
	            if (client_path == null || client_fname == null) JOptionPane.showMessageDialog(null, "파일경로와 이름을 입력해 주세요", "알림창", JOptionPane.ERROR_MESSAGE);
	            else {
					...
					if(!file.exists())	JOptionPane.showMessageDialog(null, "파일경로를 찾을 수 없습니다 \n 경로를 다시 확인해 주세요", "알림창", JOptionPane.ERROR_MESSAGE);				
						...
						int op = JOptionPane.showOptionDialog(null, "해당 파일은 존재하는 파일 입니다 \n 취소하시려면 NO \n 계속하시려면 YES를 눌려주세요", "알림창", JOptionPane.OK_CANCEL_OPTION, JOptionPane.QUESTION_MESSAGE, null, options, "NO");
						if(op == 0) {
